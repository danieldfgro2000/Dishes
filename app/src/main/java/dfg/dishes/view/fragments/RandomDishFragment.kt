...
import dfg.dishes.databinding.FragmentRandomDishBinding
import dfg.dishes.model.entities.FavDish
import dfg.dishes.model.entities.RandomDish
...
import dfg.dishes.viewmodel.RandomDishViewModel
...
class RandomDishFragment : Fragment() {
    ...
    private fun randomDishViewModelObserver(){
        mRandomDishViewModel.randomDishResponse.observe(viewLifecycleOwner, Observer {
