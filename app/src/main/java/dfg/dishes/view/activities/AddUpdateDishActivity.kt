...
import dfg.dishes.databinding.ActivityAddUpdateDishBinding
import dfg.dishes.databinding.DialogCustomImageSelectionBinding
...
//                    mBinding.ivDishImage.setImageURI(selectedPhotoUri)
    ...
    private fun customItemsListDialog(title: String,  itemsList: ArrayList<String>, selection: String){
